      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="flex items-center md:order-2">
          <div className="flex items-center md:order-2 ml-14 mr-4">
             <button type="button" data-dropdown-toggle="language-dropdown-menu" className="inline-flex justify-center items-center p-2 mr-4 text-sm text-gray-500 rounded-lg cursor-pointer hover:bg-gray-700 hover:text-white">
                { locale === "en" ? "English" : "Français" }
              </button>
              {/* Dropdown menu */}
              <div className="hidden z-50 my-4 text-base list-none rounded-md divide-y divide-gray-100 shadow bg-gray-700" id="language-dropdown-menu" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom">
              ...
              <ul className="flex flex-col p-4 mt-4  rounded-lg border md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  border-gray-700">
                ...
                <li>
                  <Link href="#projects" scroll={false} >
                    <a className="block py-2 pr-4 pl-3  rounded md:p-0 text-gray-400 md:hover:text-white hover:bg-gray-700 hover:text-white md:hover:bg-transparent border-gray-700" aria-current="page">{t("projects")}</a> 
                  </Link>
                </li>
                <li>
