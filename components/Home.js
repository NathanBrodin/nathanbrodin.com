    ...
    <section className="h-screen flex content-center" id='home'>
      <div className="relative z-10 grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-4xl mb-4 text-sm font-bold tracking-tight leading-none md:text-sm xl:text-lg text-primary-700">
              {t('home_title')}</h1>
            <h1 className="max-w-4xl mb-4 text-5xl font-extrabold tracking-tight leading-none md:text-6xl xl:text-7xl text-white">
              {t('home_name')}</h1>
            <h1 className="max-w-4xl mb-10 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-gray-400">
              {t('home_subtitle')}</h1>
            <p className="max-w-4xl mb-6 font-light  lg:mb-8 md:text-lg lg:text-xl text-gray-400">
      ...
      <div className='absolute bg-red-300 w-screen-xl h-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12'>
