...
export default function Project(props) {
  ...
  return (
    <div className='grid gap-8 content-between bg-background-600 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 p-8 rounded-lg hover:-translate-y-2 sm:hover:-translate-y-4 hover:shadow-lg transition ease-in-out duration-300 group'>
      <div>
